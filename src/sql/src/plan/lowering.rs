        ...
        maybe_grow(|| {
            ...
            Ok::<MirScalarExpr, PlanError>(match self {
                ...
                Windowing(expr) => {
                    ...
                    let scalar_lower_args = |_id_gen: &mut _,
                                             _col_map: & _,
                                             _cte_map: &mut _,
                                             _get_inner: &mut _,
                    ...
                    let value_or_aggr_lower_args = |hir_encoded_args: Box<HirScalarExpr>| |id_gen: &mut _,
                                                    col_map: & _,
                                                    cte_map: &mut _,
                                                    get_inner:  &mut _,
                    ...
                    match expr.func {
                        ...
                        WindowExprType::Aggregate(aggr_window_expr) => {
                            let hir_encoded_args = aggr_window_expr.aggregate_expr.expr.clone();
                            let mir_aggr_func = aggr_window_expr.into_expr();
