...
impl VariadicFunc {
    ...
    pub fn introduces_nulls(&self) -> bool {
        ...
        !matches!(
            ...
            And
            | Or
            //ggtodo: add some obvious ones (but not necessarily all)
        )
    }

    pub fn switch_or_and(&self) -> Self {
        match self {
    ...
    pub fn unit_of_or_and(&self) -> MirScalarExpr {
        match self {
    ...
    pub fn zero_of_or_and(&self) -> MirScalarExpr {
        match self {
...
impl fmt::Display for VariadicFunc {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            VariadicFunc::Or => f.write_str("and"),
        }
    }
}
